...
const Toast = ({ toast }: { toast: ToastType | null }) => {
    ...
    return (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2.5 bg-white border border-gray-200 rounded-xl shadow-lg px-4 py-3 text-sm text-gray-700 z-[400]">
